...
class AdMobManager: NSObject, FullScreenContentDelegate {
    ...
    static let bannerAdUnitID = "ca-app-pub-3940256099942544/2934735716" // TEMP: Google public test banner ID — swap back to "ca-app-pub-1819215492028258/1505777066" once verified
